...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="Contentdisplay col-xs-12">
            ...
            <p>IT 강국 대한민국에 클래식 음악 관련 자료를 한 눈에 검색해 볼 수 있는 싸이트가 없어, 각 공연 공연기록이나 뮤지션/오케스트라의 프로필 및 레파토리를 조회를 할 수 있는 방법이 없음을 아쉬워하는 사람들이 자발적으로 뜻과 자금을 모아, 클래식 음악계 및 공연 제반 자료를 포탈로 구축하고, 기록관에 아카이빙으로 저장하여 사후관리하는 시스템을 만듦.</p>
            <p>&nbsp;</p>
            <p><strong>운영 방침</strong><strong>:</strong></p>
            <p>본 시스템은 클래식 음악계에 활동하는 분들을 위한 것임과 동시에 구성원의 자발적 참여 없이 구축이 어려움.</p>
            <p>공연 기획사나 주관사는 무상으로 제반 공연을 홍보할 수 있도록 함.</p>
            <p>보다 많은 분들의 참여를 위해 비영리 사회적 기업으로 운영하고 매년 사업의 결과를 투명하게 공개함.</p>
            <p>본 취지를 공감하시는 분들에겐 누구든 사업의 주체로 참여할 수 있는 주식을 공개함 과 아울러 재능 기부와 자원봉사의 영역이 마련됨.</p>
            <p>본 사업을 지속 운영 가능하도록 소요 경비를 충당하기 위한 Blockchain기반의 Digital Asset 유통 시스템(Classic Coin 발행)을 운영함.</p>
        </div>
    </div>
    <div class="row">
        <hr />
