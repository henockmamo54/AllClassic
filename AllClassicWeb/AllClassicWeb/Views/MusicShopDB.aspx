            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="pull-right" style="padding: 0px; padding-right: 15px;">
                        ...
                        <asp:TextBox AutoPostBack="true" ID="txt_experties" runat="server" class="form-control filedDisplay" Style="width: 150px; display: inline-block;"></asp:TextBox>
                    </div>
                    <div class="pull-right" style="padding: 0px; padding-right: 15px;">
                        <span style="display: inline-block;padding-right: 5px;" class="filedName"><%= Resources.DisplayText.City %>  </span>
                        <asp:DropDownList Style="display: inline-block; width: 100px;" ID="DropDownList1_cityfilter" runat="server" class="form-control" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="SubCode" DataValueField="LookUpID"></asp:DropDownList>
