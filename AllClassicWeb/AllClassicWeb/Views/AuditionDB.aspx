            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="pull-right" style="padding: 0px;padding-right: 15px; ">
                        ...
                        <asp:TextBox AutoPostBack="true" ID="txt_title" runat="server" CssClass="form-control filedDisplay" Style="display: inline-block; width: 150px; display: inline-block;"></asp:TextBox>
                            ...
                            <div>
                                <asp:Label runat="server" ID="tumbinallink" Style="text-decoration: none;">
                                    ...
                                    - <%=Resources.DisplayText.ToDate %>: <%# DataBinder.Eval(Container.DataItem,"ToDate","{0:d/M/yyyy}") %></span>]
                                         <br />
                                        <div class="Contentdisplay" runat="server" style="font-size: 14px; color: black; background-color: #F5F4F4; padding: 5px; padding-top: 0px; border-radius: 5px; margin: 5px; margin-left: 0px;"><%#Server.HtmlDecode(Eval("AuditionOutline").ToString()) %></div>
