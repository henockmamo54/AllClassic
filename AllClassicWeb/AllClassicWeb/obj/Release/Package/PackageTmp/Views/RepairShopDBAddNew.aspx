...
"></asp:SqlDataSource>
    ...
    <div class="row">
        ...
        <div class="col-xs-4" style="padding: 0;">
            ...
            <div class="col-xs-6 " style="padding: 0;">
                <asp:TextBox runat="server" ID="txt_homepage"   class="form-control filedDisplay" />
            </div>
        </div>
    ...
    <div class="row col-md-4 col-xs-4">
        <asp:Button Visible="true" ID="btn_repairshop_cancel" CssClass="btn btn-danger pull-right contentButton" runat="server" Text="<%$Resources:DisplayText,Cancel %>" OnClick="btn_repairshop_cancel_Click" Style="margin-right: 10px;" />
        <asp:Button Visible="true" ID="btn_repairshop_save" CssClass="btn btn-warning pull-right contentButton" runat="server" Text="<%$Resources:DisplayText,Update %>" OnClick="btn_repairshop_save_Click" Style="margin-right: 10px;" />
        <asp:Button ID="btn_repairshop_add" CssClass="btn btn-primary pull-right contentButton" runat="server" Text="<%$Resources:DisplayText,Add %>" OnClick="btn_repairshop_add_Click" Style="margin-right: 10px;" />
