            ...
            <div class="conbox">
                ...
                <div class="con_section1">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="on"><a runat="server" href="~/Views/RepairShopDB.aspx"><%= Resources.DisplayText.RepairShop %></a></li>
                ...
                <div class="con_section2">
                    ...
                    <h2><%= Resources.DisplayText.RepairShop %></h2>

                    <div class="conlist">
                        <ul class="agora">
                            <li><%= Resources.DisplayText.Name %>
                                <asp:TextBox AutoPostBack="true" ID="txtbox_namefilter" runat="server" Style="display: inline-block;"></asp:TextBox>
                            </li>
...
order by UpdateTimeStamp desc"></asp:SqlDataSource>
                    ...
                    <div class="agoralist2">
                        <asp:ListView runat="server" ID="collegeListContainer" DataKeyNames="RepairShopID" DataSourceID="SqlDataSource1_Collegelist" GroupItemCount="2" OnItemDataBound="collegeListContainer_OnItemDataBound">
                                ...
                                <li>
                                    ...
                                    <ul class="txt">
                                        ...
                                        <li><span>- <%# Resources.DisplayText.HomePage %></span>
                                            <asp:LinkButton runat="server" Style="display: inline-block" target="_blank" OnCommand="homePageClicked" CommandArgument='<%# Eval("HomePage") %>' Text='<%# Eval("HomePage") %>'></asp:LinkButton></li>
                                        <li>
                                            <asp:LinkButton Style="display: inline-block" runat="server" ID="edit" OnCommand="editRepairShopClicked" CommandArgument='<%# Eval("RepairShopID") %>'> <%= Resources.DisplayText.Edit %></asp:LinkButton>
                                            <asp:LinkButton Style="display: inline-block" runat="server" ID="delete" OnClientClick='<%# "deletebtnclicked(" +Eval("RepairShopID") + " );" %>' Text="<%$Resources:DisplayText,delete %>"></asp:LinkButton>
                                        </li>
                                    </ul>
                                </li>
