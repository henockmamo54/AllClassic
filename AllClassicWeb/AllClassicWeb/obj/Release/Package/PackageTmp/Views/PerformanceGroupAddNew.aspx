...
"></asp:SqlDataSource>
                        ...
                        <div class="col-md-4 col-xs-4 userregisterinfo">
                            <br />
                            <div class="col-md-4 col-xs-4 filedName"><%= Resources.DisplayText.SinceYear %>*</div>
                            <div class="col-md-8 col-xs-8">
                                <asp:TextBox ID="txt_sinceyear"  ValidationGroup="a" runat="server"  MaxLength="4"  class="form-control filedDisplay"></asp:TextBox>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-md-4 col-xs-4 userregisterinfo">
                            ...
                            <div class="col-md-8 col-xs-8">
                                <asp:TextBox ID="txt_zipcode"  ValidationGroup="a" MaxLength="6" runat="server" class="form-control filedDisplay"></asp:TextBox>
            ...
            <div class="row">
                ...
                <div class="row col-md-12 col-xs-12">
                    <asp:Button Visible="true" ID="btn_pg_cancel" CssClass="btn btn-danger pull-right contentButton" runat="server" Text="<%$Resources:DisplayText,Cancel %>" OnClick="btn_pg_cancel_Click" Style="margin-right: 10px;" />
                    <asp:Button Visible="true" ID="btn_pg_save"  ValidationGroup="a"  CssClass="btn btn-warning pull-right contentButton" runat="server" Text="<%$Resources:DisplayText,Update %>" OnClick="btn_pg_save_Click" Style="margin-right: 10px;" />
                    <asp:Button ID="btn_pg_add" CssClass="btn btn-primary pull-right contentButton"  ValidationGroup="a"  runat="server" Text="<%$Resources:DisplayText,Add %>" OnClick="btn_pg_add_Click" Style="margin-right: 10px;" />
                </div>
            </div>
